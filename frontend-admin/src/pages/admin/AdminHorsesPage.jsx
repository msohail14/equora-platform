  ...
  return (
    <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
      ...
      <Modal
        ...
        title={selectedHorse?.name ? `Horse Details - ${selectedHorse.name}` : 'Horse Details'}
        onClose={() => {
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div>
                ...
                <p className="text-sm text-gray-900 dark:text-gray-100">{selectedHorse.name || '-'}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Breed</p>
                <p className="text-sm text-gray-900 dark:text-gray-100">{selectedHorse.breed || '-'}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Stable</p>
                <p className="text-sm text-gray-900 dark:text-gray-100">{selectedHorse.stable?.name || '-'}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Discipline</p>
                <p className="text-sm text-gray-900 dark:text-gray-100">{selectedHorse.discipline?.name || '-'}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Status</p>
                <p className="text-sm text-gray-900 dark:text-gray-100 capitalize">{selectedHorse.status || '-'}</p>
              </div>
            </div>
            <div>
